...
import (
	...
	"github.com/icougil/elastic/app/user"
...
func main() {
	...
	r.GET("/api/users/", func(c *gin.Context) { c.JSON(200, gin.H{}) })
	r.POST("/api/users/create", user.CreateUserHandler(logger, user.NewUserStore(db, logger)))
